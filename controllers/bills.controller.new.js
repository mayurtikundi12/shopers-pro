...
let ObjectId = require('mongodb').ObjectId ; 
 ...
 module.exports.addbill =  function(req,res,next){
    ...
    // checking if the product is available
      ...
      var productDetails =  getproduct(qbody.pname) ; //pname = product name
      var customerDetails =  getcustomer(qbody.cname) ; // cname = customer name
    finishinsertion(res , productDetails , customerDetails)
      console.log("After Await",productDetails);
      console.log("After Await",customerDetails);
